...
Singleton {
    ...
    readonly property var rarezas: [
        { nombre: "Común",      color: "#e4e4e4", valor: 10,     mult: 1.00 },
        { nombre: "Poco común", color: "#54fc0c", valor: 30,     mult: 1.35 },
        { nombre: "Raro",       color: "#2f8bfc", valor: 90,     mult: 1.80 },
        { nombre: "Legendario", color: "#fc9c0c", valor: 270,    mult: 2.40 },
        { nombre: "Inmortal",   color: "#fc2424", valor: 810,    mult: 3.20 },
        { nombre: "Arcano",     color: "#b40cfc", valor: 2592,   mult: 4.30 },
        { nombre: "Más allá",   color: "#fc246c", valor: 8294,   mult: 5.70 },
        { nombre: "Celestial",  color: "#6ccce4", valor: 29029,  mult: 7.60 },
        { nombre: "Divino",     color: "#fce454", valor: 101602, mult: 10.10 },
        { nombre: "Cósmico",    color: "#fcfcfc", valor: 355607, mult: 13.50 }
    ]
    ...
    readonly property var huecos: [
        {
            id: "arma", nombre: "Arma", glifo: 0xF04E5,
        ...
        {
            id: "escudo", nombre: "Mano izquierda", glifo: 0xF0498,
        ...
        {
            id: "armadura", nombre: "Armadura", glifo: 0xF0A38,
        ...
        {
            id: "amuleto", nombre: "Accesorio", glifo: 0xF0DFA,
    ...
    readonly property var cofres: [
        { nombre: "Cofre corriente", color: "#8e8e93", suelo: 0, empuje: 0.0,  glifo: 0xF04D6 },
        { nombre: "Cofre de jefe",   color: "#2f8bfc", suelo: 2, empuje: 0.35, glifo: 0xF04D7 },
        { nombre: "Cofre de acto",   color: "#fc9c0c", suelo: 3, empuje: 0.75, glifo: 0xF0A75 }
    ]
