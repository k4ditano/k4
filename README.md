...
| `k4.editor` | `abrir` · `examinar` · `editar <ruta>` · `retomar` · `imagen <ruta> <t>` · `imagenEncima <ruta> <t>` · `congelar <t> <dur>` · `elegirTrozo <n>` · `separarAudio` · `devolverAudio` · `subtitular` · `formato <mp4|webm|gif>` · `silencios` · `quitarSilencios` · `olvidarSilencios` · `grande` · `encoger` |
